...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	integration := admin.Group("/integration")
	{
		integration.GET("/groups", h.Admin.Account.ListIntegrationGroups)
		integration.POST("/accounts", h.Admin.Account.CreateIntegrationAccount)
	}
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/codex-continuations", h.Admin.Usage.ListCodexContinuations)
