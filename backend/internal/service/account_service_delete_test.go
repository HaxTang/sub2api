...
func (s *accountRepoStub) ListWithFilters(ctx context.Context, params pagination.PaginationParams, filters AccountListFilters) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected ListWithFilters call")
}

func (s *accountRepoStub) ListAllWithFilters(context.Context, AccountListFilters) ([]Account, error) {
	return nil, nil
}
