...
func (c *schedulerTestGatewayCache) IsUpstreamSiteCooling(ctx context.Context, siteKey string) (bool, error) {
	return false, nil
}

func (c *schedulerTestGatewayCache) SetUpstreamSiteCooldown(ctx context.Context, siteKey string, ttl time.Duration) error {
	return nil
}
