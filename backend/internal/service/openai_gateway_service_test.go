...
func (c *stubGatewayCache) IsUpstreamSiteCooling(ctx context.Context, siteKey string) (bool, error) {
	return false, nil
}

func (c *stubGatewayCache) SetUpstreamSiteCooldown(ctx context.Context, siteKey string, ttl time.Duration) error {
	return nil
}
