...
func (m *sessionWindowMockRepo) ListWithFilters(context.Context, pagination.PaginationParams, AccountListFilters) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
func (m *sessionWindowMockRepo) ListAllWithFilters(context.Context, AccountListFilters) ([]Account, error) {
	panic("unexpected")
}
